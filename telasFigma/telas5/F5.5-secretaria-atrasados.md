# F5.5 — Solicitações atrasadas

**Rota:** `/secretaria/atrasados`  
**Fluxo:** F5  
**Shell:** AppLayout  
**Plataforma:** Web + Mobile  
**Prioridade:** P2  
**Capability:** `request.view_curso`  
**API primária:** `GET /requests?slaBreached=true`
...
```
PageContent
  ├─ Header row: H1 + Button primary "Exportar"
  ├─ FilterBar (gap space/sm): n/a
  ├─ DataTable / Card list
  │    Colunas: Igual F5.2
  └─ Pagination footer
```
