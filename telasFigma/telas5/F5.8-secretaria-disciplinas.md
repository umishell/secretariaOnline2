...
**Rota:** `/secretaria/disciplinas`  
**Fluxo:** F5  
**Shell:** AppLayout  
**Plataforma:** Web + Mobile  
**Prioridade:** P2  
**Capability:** `subject.manage`  
**API primária:** `/secretaria/disciplinas` CRUD

---

## 1. Propósito

CRUD disciplinas com busca e export CSV.
...
PageContent
  ...
  ├─ FilterBar (gap space/sm): busca, filtros
  ├─ DataTable / Card list
  │    Colunas: Nome, Curso, Período, Ativa
  └─ Pagination footer
```
