...
**API primária:** `GET /internships?aluno=me`

---

## 1. Propósito

Lista estágios com empresa, vigência, pendências.
...
PageContent
  ...
  ├─ FilterBar (gap space/sm): situação
  ├─ DataTable / Card list
  │    Colunas: Empresa, Supervisor, Vigência, Situação
  └─ Pagination footer
```
